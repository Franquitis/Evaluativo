...
//Guardian para la vista de adminisrador
import { rutaProtegidaGuard } from 'src/app/guards/ruta-protegida.guard';
...
const routes: Routes = [
  ...
  },
  {
    ...
    //definirle el guardian que proteja la ruta de Admin y que espere un rol de tipo "admin"
