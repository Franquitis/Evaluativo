...
//Observable paa obtener cambios
...
export class AuthService {
  ...
  obtenerRol(uid: string): Observable<string | null> {
    //Accedemos a colleccion de usuarios, buscando por UID, obteniendo cambios en valores.
  ...
  //Obtener  el rol y asignarlo el rol de la variable local
